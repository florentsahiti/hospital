...
const Navbar = () => {
  ...
  return (
    <div className='flex item-center justify-between text-sm py-4 mb-5 border-b border-gray-400'>
        ...
        <div className='flex items-center gap-4'>
          ...
          {/* MObbile Menu */}
          <div className={`${showMenu ? 'fixed w-full h-full left-0 top-0' : 'h-0 w-0'} md:hidden z-20 overflow-hidden bg-white transition-all`}>
